...
# Selección del número de variables independientes
st.sidebar.subheader("Variables Independientes")
num_variables = st.sidebar.radio("Número de variables independientes:", [1, 2], index=0)

variables_independientes = []
if num_variables == 1:
    variable1 = st.sidebar.text_input("Nombre de la variable independiente:", value="x")
    variables_independientes.append(variable1)
    
    # Rango para variable1 con sliders en la misma fila
    st.sidebar.subheader(f"Rango de {variable1}")
    ...
    variables_independientes.extend([variable1, variable2])
    ...
    st.sidebar.subheader(f"Rango de {variable2}")
